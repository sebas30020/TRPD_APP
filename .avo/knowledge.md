...
16. **Convenciones de unidades y direcciones**: µs y mV en memoria, ns en disco (YAML) y en la GUI; segmentos 1-based; `carpeta` es la ruta ABSOLUTA de la medición, elegida con el explorador de carpetas (sin carpeta de datos fija, ver `rutas.py`); los datos `.h5` viven fuera del repositorio.
